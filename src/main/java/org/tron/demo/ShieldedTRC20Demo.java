...
import org.kcoin.api.GrpcAPI.SpendNoteTRC20;
...
import org.kcoin.common.utils.Hash;
...
import org.kcoin.walletserver.GrpcClient;
...
public class ShieldedTRC20Demo {
  ...
  private byte[] triggerGetScalingFactor(byte[] contractAddress) {
    ...
    GrpcAPI.TransactionExtention symExt2 = grpcClient.triggerConstantContract(
        triggerBuilder.build());
    List<ByteString> list = symExt2.getConstantResultList();
