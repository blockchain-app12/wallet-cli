...
import org.kcoin.common.crypto.jce.ECKeyAgreement;
import org.kcoin.common.crypto.jce.ECKeyFactory;
import org.kcoin.common.crypto.jce.ECKeyPairGenerator;
import org.kcoin.common.crypto.jce.ECSignatureFactory;
...
public class ECKey implements Serializable, SignInterface {
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(KcoinCastleProvider.getInstance(), privateKeyFromBigInteger(priv), pub);
  }
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory.getInstance(KcoinCastleProvider.getInstance())
